export const BALLPARKS = {
  '嘉義市': { city: '嘉義市', district: '東區' },
  '新莊': { city: '新北市', district: '新莊區' },
  '澄清湖': { city: '高雄市', district: '鳥松區' },
  '天母': { city: '臺北市', district: '士林區' },
  '花蓮': { city: '花蓮縣', district: '花蓮市' },
  '斗六': { city: '雲林縣', district: '斗六市' },
  '台東': { city: '臺東縣', district: '臺東市' },
  '洲際': { city: '臺中市', district: '北屯區' },
  '樂天桃園': { city: '桃園市', district: '中壢區' },
  '大巨蛋': { city: '臺北市', district: '信義區' },
  '亞太主': { city: '臺南市', district: '安南區' },
};
